...
def test_print_mixin(capsys):
    ...
    assert message.out.strip() == 'Product(Samsung Galaxy C23 Ultra, 256GB, Серый цвет, 200MP камера)'
    ...
    message = capsys.readouterr()
    assert message.out.strip() == 'LawnGrass(Газонная трава, Элитная трава для газона)'
